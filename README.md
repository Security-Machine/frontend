...
Mono-repo for the security-machine project.

The code in this repository represents the front-end part of the project.
The back-end part is hosted in a separate repository.
...
- `compilerOptions`:
  ...
  - `paths`: enables the use of
    ...
    its content using `@secma/some-package`;
